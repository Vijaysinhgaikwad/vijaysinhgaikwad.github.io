...
/* ===== Animated About Contact Section ===== */
...
/* ===== Slide + Wave Animation ===== */

.animated-contact {
    animation: slideWave 5s ease-out forwards;
}
...
/* Smooth stop after animation */
.animated-contact:hover {
    animation-play-state: paused;
}

/* Cursor hover = subtle glow */
.about-contact a:hover {
    text-shadow: 0 4px 15px rgba(13, 110, 253, 0.45);
}
...
.resume-section-content h2.typing-title {
    font-size: 1.25rem;
    font-weight: 600;
    margin-top: 8px;
    margin-bottom: 20px;
...
/* Button hover (only when cursor is on button) */
.interest-card .btn:hover {
    background-color: #6610f2; /* slightly vibrant purple-blue */
    border-color: #6610f2;
    box-shadow: 0 8px 18px rgba(102, 16, 242, 0.4);
    transform: translateY(-2px);
}
/* Button reacts when card is hovered */
.interest-card:hover .btn {
